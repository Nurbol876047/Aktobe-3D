const data = [
  ...
  },
  {
    ...
    title2: "ЕМЕЛ",
    description:
      "Алтын-Эмель ұлттық паркі түрлі түсті Ақтау тауларымен және кең дала көрінісімен танымал. Қабат-қабат жартастар бұл жерді табиғаттың ашық аспан астындағы мұражайындай көрсетеді.",
    image: "./assets/altyn-emel.png",
  },
  {
  ...
  },
  {
    ...
    title2: "ҚАЛАСЫ",
    description:
      "Көшпенділер қаласы қазақ даласының тарихи рухын сезіндіретін ерекше мәдени нысан. Қамалдар, қақпалар және киіз үйлер көне заман атмосферасын көз алдыңа әкеледі.",
    image: "./assets/nomad-city.png",
  },
  {
    place: "Табиғи шатқал",
    title: "ВОЛЧИЙ",
